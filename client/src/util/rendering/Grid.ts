...
export class Grid {
    ...
    constructor(
        ...
        // const structures = this._tilemap.createBlankLayer('structures', structureTileset);
        if(walls === null) {
            throw new Error("Missing layers in grid");
        }
        this._walls = walls;
    }
    ...
    private _drawSeamlessTile(layer: Phaser.Tilemaps.TilemapLayer, x: number, y: number) {
